...
<head>
    ...
    <link href="{{ asset('admin_assets/vendor/bootstrap-progressbar/bootstrap-progressbar-3.3.4.min.css') }}"
        rel="stylesheet" media="all">
    <link href="{{ asset('admin_assets/vendor/select2/select2.min.css') }}" rel="stylesheet" media="all">
    <link href="{{ asset('admin_assets/vendor/perfect-scrollbar/perfect-scrollbar.css') }}" rel="stylesheet"
        media="all">
...
<body class="animsition">
    <div class="page-wrapper">
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="@yield('tax_select')">
                            <a href=" {{ url('admin/tax') }}">
                                <i class="fab fa-money"></i>Tax</a>
                        </li>

                        <li class="@yield('brand_select')">
                            <a href=" {{ url('admin/brand') }}">
                                <i class="far fa-copyright"></i></i>Brand</a>
                        </li>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="@yield('tax_select')">
                            <a href=" {{ url('admin/tax') }}">
                                <i class="far fa-money-bill-alt"></i>Tax</a>
                        </li>
                        ...
                        <li class="@yield('banner_select')">
                            <a href=" {{ url('admin/banner') }}">
                                <i class="fab fa-accusoft"></i>Banner</a>
                        </li>
        ...
        <div class="page-container">
            ...
            <!-- MAIN CONTENT-->
            <div style="padding-top: 59px !important" class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row ">
                            <div class="col-md-12">
